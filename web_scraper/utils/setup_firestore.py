    ...
    try:
        ...
        locations = [{
            ...
            'province': 'Ontario',
                        ...
                        'grading_scale': ['VB/V0', 'V0/V1', 'V1/V2', 'V2/V3', 'V3/V4', 'V4/V5', 'V5/V6', 'V6/V7', 'V7/V8', 'V8/V9', 'V9+',
            ...
            'province': 'Quebec',
                        ...
                        'grading_scale': ['VB/V0', 'V0/V1', 'V1/V2', 'V2/V3', 'V3/V4', 'V4/V5', 'V5/V6', 'V6/V7', 'V7/V8', 'V8/V9', 'V9+', 'competition', 'routesetting-squad'],
                        'capacity': 75,
        }, {
            ...
            'province': 'Ontario',
                        ...
                        'grading_scale': ['White', 'Orange', 'Red', 'Blue', 'Green', 'Purple', 'Black', 'Ungraded'],
                        'capacity': 50,
        }]
...
def main():
    ...
    # Read Bookings data
    bookings = common.load_bulk_json(
        os.path.join(glbs.ES_BULK_DATA, 'bookings.json'))
