...
_altitude_kanata = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_altitude_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_altitude_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_altitude.yaml')
_altitude_gatineau = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_altitude_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_altitude_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_altitude.yaml')
_coyote_rock_gym = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_coyote_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_coyote_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_coyote.yaml')
_klimat = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_klimat_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_klimat_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_klimat.yaml')
_calabogie = os.path.join(
    TEMPLATE_DIR, 'outdoor_bouldering_calabogie_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'outdoor_bouldering_calabogie_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'outdoor_bouldering_calabogie.yaml')
_up_the_bloc = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_up_the_bloc_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_up_the_bloc_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_up_the_bloc.yaml')
_cafe_bloc = os.path.join(
    TEMPLATE_DIR, 'indoor_bouldering_cafe_bloc_personal.yaml') if os.path.exists(os.path.join(TEMPLATE_DIR, 'indoor_bouldering_cafe_bloc_personal.yaml')) else os.path.join(TEMPLATE_DIR, 'indoor_bouldering_cafe_bloc.yaml')
_hogs_back = os.path.join(
